...
// Study_MFC.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CStudy_MFCApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CStudy_MFCApp::OnAppAbout)
...
// CStudy_MFCApp construction

CStudy_MFCApp::CStudy_MFCApp()
{
	// TODO: replace application ID string below with unique ID string; recommended
	// format for string is CompanyName.ProductName.SubProduct.VersionInformation
	SetAppID(_T("Study_MFC.AppID.NoVersion"));

	// TODO: add construction code here,
	// Place all significant initialization in InitInstance
}

// The one and only CStudy_MFCApp object

CStudy_MFCApp theApp;

Gdiplus::GdiplusStartupInput gdiplusStartupInput;
ULONG_PTR gdiplusToken;

// CStudy_MFCApp initialization

BOOL CStudy_MFCApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CStudy_MFCDoc),
		RUNTIME_CLASS(CMainFrame),       // main SDI frame window
		RUNTIME_CLASS(CStudy_MFCView));
	if (!pDocTemplate)
		return FALSE;
...
int CStudy_MFCApp::ExitInstance()
{
	pRenderer->Shutdown();
	if (pRenderer) {
		delete pRenderer;
...
// CStudy_MFCApp message handlers
...
//void CStudy_MFCApp::OnSettings()
//{
//	CPropertySheet sheet(L"Options");
//	sheet.AddPage(&m_settingsPage);
//
//	sheet.DoModal();
//}
